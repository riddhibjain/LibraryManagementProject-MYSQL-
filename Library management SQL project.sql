...
SELECT issuestatus.Issued_book_name, customer.Customer_name FROM 
...
# 8. Display the names of customers who have issued books in the month of January 2023.
SELECT customer.Customer_name FROM customer INNER JOIN issuestatus ON 
customer.Customer_Id = issuestatus.Issued_cust WHERE issuestatus.Issue_date >= '2023-01-01' AND 
issuestatus.Issue_date <= '2023-01-30';
select * from issuestatus ;
# 9. Retrieve book_title from book table containing 'classic'.
